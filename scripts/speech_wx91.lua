return {
	...
	DESCRIBE =
	{
        ...
        QUAGMIRE_RUBBLE_HOUSE = {"LIKELY REASON FOR ABANDONMENT: ANNIHILATION", "VILLAGE HAS BEEN ABANDONED", "EVIDENCE OF DIVINE WRATH",},
        ...
        --QUAGMIRE_FOOD_PLATE = "IT IS A PLATE TO PUT FOOD ON",
        --QUAGMIRE_FOOD_BOWL = "VESSEL FOR LIQUID FOODS",
        --QUAGMIRE_FOOD_SOUP = "ENERGY WHICH CONTAINS LIQUID, MY ENEMY",
        --QUAGMIRE_FOOD_SNACK = "SMALL PACKET OF ENERGY",
        --QUAGMIRE_FOOD_BREAD = "GLUTEN BASED ENERGY",
        --QUAGMIRE_FOOD_PASTA = "GRAIN BASED MEAL",
        --QUAGMIRE_FOOD_VEGGIE = "CONTAINS ENERGY GROWN FROM THE GROUND",
        --QUAGMIRE_FOOD_MEAT = "REQUIRES NONFUNCTIONING BIOLOGICAL UNITS",
        --QUAGMIRE_FOOD_FISH = "ASSEMBLED WITH WATER BASED BIO-UNITS",
        --QUAGMIRE_FOOD_CRAB = "ENERGY PACKET FABRICATED WITH BIOLOGICAL ROCKS",
        --QUAGMIRE_FOOD_CHEESE = "ITS GOOEYNESS DOES NOT COMPUTE",
        --QUAGMIRE_FOOD_SWEET = "CONTAINS HIGH LEVELS OF SUCROSE",
        QUAGMIRE_FOOD =
        {
        ...
        --QUAGMIRE_SEEDPACKET_SMALL = "A MEAGER AMOUNT OF LIFEPODS",
        --QUAGMIRE_SEEDPACKET_MEDIUM = "A MEDIAN AMOUNT OF LIFEPODS",
        --QUAGMIRE_SEEDPACKET_LARGE = "AN ABUNDANT AMOUNT OF LIFEPODS",
        --QUAGMIRE_SEEDPACKET_MIX_SMALL = "VARIETY OF LIFEPODS",
        --QUAGMIRE_SEEDPACKET_MIX_MEDIUM = "PLANTING A VARIETY OF LIFEPODS IS INEFFECIENT",
        --QUAGMIRE_SEEDPACKET_MIX_LARGE = "LIFEFORMS ARE NOT OF UNIFORM APPEARANCE",
        ---
        QUAGMIRE_POT = "THIS POT HAS AN ACCEPTABLE MEMORY SIZE",
        QUAGMIRE_POT_SMALL = "THIS POT HAS INADEQUATE MEMORY SIZE",
